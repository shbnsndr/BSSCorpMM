...
<html>
	...
	<g:form controller="Account" action="addAccount" onsubmit="return validateInputs('accountName&&accountType&&currentBalance','','jsErrorMsg')">
	<table>
	...
	<td><input class="TEXT_INPUT" type="text" name="accountName" id="accountName"> </td><td></td>
	</tr>
	
	<tr>
	<td>Account Type*</td><td></td>
	<td><input class="TEXT_INPUT" type="text" name="accountType" id="accountType"> </td><td></td>
	<td></td>
	</tr>
	
	<tr>
	<td>Current Balance*</td><td></td>
	<td><input class="TEXT_INPUT" type="text" name="currentBalance" id="currentBalance"> </td><td></td>
	</tr>
