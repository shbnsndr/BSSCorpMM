...
function calculateNos(var i){
	var denominationUnit = parseInt($("denominationUnit_"+i).val());
	var denominationNos = parseInt($("denominationNos_"+i).val());
	var denominationValue = denominationUnit*denominationNos;
	$("denominationValue_"+i).val(denominationValue);
}
